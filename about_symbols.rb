...
class AboutSymbols < Neo::Koan
  ...
  #
  # Symbol syntax will create a symbol when `:test_method_names_become_symbols` is encountered.
  # So it is meaningless if we assert like Symbol.all_symbols.include?(:test_method_names_become_symbols)
